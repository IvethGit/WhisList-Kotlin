...
fun ProductItem(product: Product) {
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(
                containerColor = colors.surfaceVariant // O surface si prefieres menos contraste
            ),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(
                    text = when (product.status) {
                        ProductStatus.HAVE_IT -> "Estado: Lo tengo"
                        ProductStatus.IN_PROGRESS -> "Estado: En progreso"
                        ProductStatus.WANT_IT -> "Estado: Lo quiero"
                    },
